...
- 실패
  ...
  - 유저가 포인트 충전 후 포인트 합계 조회가 1,000,000 초과면 실패한다.
  - 유저가 포인트 충전 후 포인트 합계 조회가 0 미만이면 실패한다.
...
- 실패
  ...
  - 유저가 포인트 사용 후 포인트 합계 조회가 1,000,000 초과면 실패한다.
  - 유저가 포인트 사용 후 포인트 합계 조회가 0 미만이면 실패한다.
